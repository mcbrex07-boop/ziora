...
export const metadata: Metadata = {
  title: `Terms and Conditions - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> Terms and Conditions</div>
  </div>
</section>
...
<div class="page-content">
  <div class="container" style="max-width:900px;">
    ...
    <p style="color:#666666;margin-bottom:24px;">Last updated: January 1, 2024</p>
    <p style="margin-bottom:16px;">Welcome to McBrex Lifesciences. By accessing and using our website, you accept and agree to be bound by these Terms and Conditions.</p>
    <h3 style="margin:28px 0 12px;">Use of Website</h3>
    <p style="margin-bottom:16px;">The content of this website is for informational purposes only. Unauthorized use of this website may give rise to a claim for damages and/or be a criminal offense.</p>
    <h3 style="margin:28px 0 12px;">Intellectual Property</h3>
    <p style="margin-bottom:16px;">All trademarks, logos, and content on this website are the property of McBrex Lifesciences. Reproduction is prohibited without prior written consent.</p>
    <h3 style="margin:28px 0 12px;">Product Information</h3>
    <p style="margin-bottom:16px;">Product information on this website is subject to change without notice. All products should be used under medical supervision.</p>
    <h3 style="margin:28px 0 12px;">Disclaimer</h3>
    <p style="margin-bottom:16px;">The information on this website is provided &quot;as is&quot; without warranties of any kind. McBrex Lifesciences shall not be liable for any damages arising from the use of this website.</p>
    <h3 style="margin:28px 0 12px;">Governing Law</h3>
    <p style="margin-bottom:16px;">These terms and conditions are governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of the courts in Haryana, India.</p>
    <h3 style="margin:28px 0 12px;">Contact</h3>
    <p style="margin-bottom:16px;">For any questions regarding these terms, please contact us at info@mcbrexlifesciences.com.</p>
  </div>
</div>
