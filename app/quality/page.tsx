...
export const metadata: Metadata = {
  title: `Quality - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/about">About Us</a> <span>/</span> Quality</div>
  </div>
</section>
  ...
  <div class="container">
    <div class="grid-2" style="align-items:center;margin-bottom:48px;">
      <div>
        ...
        <p>Quality is the cornerstone of everything we do at McBrex Lifesciences. Our commitment to delivering safe, effective, and reliable pharmaceutical products is unwavering.</p>
        <p>We partner exclusively with manufacturing facilities that hold <strong>WHO-GMP certification</strong> and follow stringent quality control protocols at every stage of production.</p>
      </div>
      <div style="display:flex;gap:24px;justify-content:center;">
        <div style="width:140px;height:140px;border-radius:50%;background:#F5F5F5;display:flex;flex-direction:column;align-items:center;justify-content:center;border:3px solid #D92323;">
          <i class="fas fa-certificate" style="font-size:32px;color:#D92323;margin-bottom:4px;"></i>
          <span style="font-size:11px;font-weight:600;text-align:center;">ISO 9001:2015</span>
        </div>
        <div style="width:140px;height:140px;border-radius:50%;background:#F5F5F5;display:flex;flex-direction:column;align-items:center;justify-content:center;border:3px solid #D92323;">
          <i class="fas fa-globe" style="font-size:32px;color:#D92323;margin-bottom:4px;"></i>
          <span style="font-size:11px;font-weight:600;text-align:center;">WHO-GMP</span>
        </div>
      </div>
    </div>
    <h2 style="text-align:center;margin-bottom:32px;">Our Quality Control Process</h2>
    <div class="grid-4">
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-search"></i></div>
        <h3>Raw Material Testing</h3>
        <p>All raw materials undergo rigorous testing before production begins.</p>
      </div>
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-cogs"></i></div>
        <h3>In-Process Control</h3>
        <p>Continuous monitoring during manufacturing to ensure consistency.</p>
      </div>
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-vial"></i></div>
        <h3>Finished Product Testing</h3>
        <p>Comprehensive analysis of every batch before release.</p>
      </div>
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-truck"></i></div>
        <h3>Post-Distribution Monitoring</h3>
        <p>Track product performance and collect feedback continuously.</p>
      </div>
    </div>
  </div>
</div>
