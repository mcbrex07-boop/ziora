...
export const metadata: Metadata = {
  title: `Board of Directors - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/about">About Us</a> <span>/</span> Board of Directors</div>
  </div>
</section>

<div class="page-content">
  <div class="container">
    <p class="section-subtitle">Meet the visionary leaders guiding McBrex Lifesciences towards excellence in healthcare.</p>
    <div class="grid-3">
      <div class="card" style="text-align:center;padding:40px;">
        <div style="width:120px;height:120px;border-radius:50%;background:#F5F5F5;margin:0 auto 20px;display:flex;align-items:center;justify-content:center;">
          <i class="fas fa-user" style="font-size:60px;color:#CCCCCC;"></i>
        </div>
        <h3 style="margin-bottom:4px;">Director Name</h3>
        <p style="color:#D92323;font-weight:600;margin-bottom:12px;">Managing Director</p>
        <p style="font-size:14px;color:#666666;">Visionary leader with over 20 years of experience in the pharmaceutical industry, driving McBrex towards innovation and excellence.</p>
      </div>
      <div class="card" style="text-align:center;padding:40px;">
        <div style="width:120px;height:120px;border-radius:50%;background:#F5F5F5;margin:0 auto 20px;display:flex;align-items:center;justify-content:center;">
          <i class="fas fa-user" style="font-size:60px;color:#CCCCCC;"></i>
        ...
        <h3 style="margin-bottom:4px;">Director Name</h3>
        <p style="color:#D92323;font-weight:600;margin-bottom:12px;">Director - Operations</p>
        <p style="font-size:14px;color:#666666;">Expert in pharmaceutical operations and supply chain management, ensuring seamless delivery across India.</p>
      </div>
      <div class="card" style="text-align:center;padding:40px;">
        <div style="width:120px;height:120px;border-radius:50%;background:#F5F5F5;margin:0 auto 20px;display:flex;align-items:center;justify-content:center;">
          <i class="fas fa-user" style="font-size:60px;color:#CCCCCC;"></i>
        ...
        <h3 style="margin-bottom:4px;">Director Name</h3>
        <p style="color:#D92323;font-weight:600;margin-bottom:12px;">Director - Quality</p>
        <p style="font-size:14px;color:#666666;">Leading our quality assurance initiatives with a focus on WHO-GMP compliance and patient safety.</p>
      </div>
    </div>
  </div>
</div>
