...
export const metadata: Metadata = {
  title: `Privacy Policy - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> Privacy Policy</div>
  </div>
</section>
...
<div class="page-content">
  <div class="container" style="max-width:900px;">
    ...
    <p style="margin-bottom:16px;">McBrex Lifesciences (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information.</p>
    <h3 style="margin:28px 0 12px;">Information We Collect</h3>
    <p style="margin-bottom:16px;">We collect information you provide directly to us, including your name, email address, phone number, and any other information you choose to provide when filling out forms on our website.</p>
    <h3 style="margin:28px 0 12px;">How We Use Your Information</h3>
    <ul style="padding-left:24px;list-style:disc;margin-bottom:16px;">
      <li style="margin-bottom:8px;">To respond to your enquiries and provide customer support</li>
      <li style="margin-bottom:8px;">To process franchise applications and job applications</li>
      <li style="margin-bottom:8px;">To send you updates about our products and services</li>
      <li>To improve our website and user experience</li>
    </ul>
    <h3 style="margin:28px 0 12px;">Information Sharing</h3>
    <p style="margin-bottom:16px;">We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as required by law.</p>
    <h3 style="margin:28px 0 12px;">Cookies</h3>
    <p style="margin-bottom:16px;">Our website may use cookies to enhance your browsing experience. You can choose to disable cookies through your browser settings.</p>
    <h3 style="margin:28px 0 12px;">Contact Us</h3>
    <p style="margin-bottom:16px;">If you have any questions about this Privacy Policy, please contact us at info@mcbrexlifesciences.com.</p>
  </div>
</div>
