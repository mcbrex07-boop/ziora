...
export const metadata: Metadata = {
  title: `Landing Page - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/about">About Us</a> <span>/</span> Landing Page</div>
  </div>
</section>

<!-- Hero -->
<section class="hero" style="background:linear-gradient(135deg,#1A1A1A 0%,#333333 100%);min-height:450px;">
  <div class="container">
    <div class="hero-content" style="max-width:700px;">
      <p class="hero-tag" style="color:#D92323;font-weight:600;">YOUR GATEWAY TO QUALITY HEALTHCARE</p>
      <h1 class="hero-title" style="color:#FFFFFF;font-size:44px;">Partner With McBrex Lifesciences</h1>
      <p class="hero-desc" style="color:#AAAAAA;">Join India's fastest-growing pharmaceutical trading company. Get access to 201+ WHO-GMP certified products across 6 specialized divisions.</p>
      <div class="hero-buttons">
        <a href="/contact" class="btn btn-primary">Get Started Today</a>
        <a href="/products" class="btn btn-white">Explore Products</a>
      </div>
    </div>
  </div>
</section>
...
<section class="section-padding">
  <div class="container">
    <h2 class="section-title">Why Partner With McBrex?</h2>
    <div class="grid-3">
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-shield-alt"></i></div>
        <h3>WHO-GMP Certified</h3>
        <p>All products manufactured in WHO-GMP certified facilities with strict quality control.</p>
      </div>
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-map-marked-alt"></i></div>
        <h3>Monopoly Rights</h3>
        <p>Exclusive distribution rights in your territory with no competition from our other partners.</p>
      </div>
      <div class="card icon-box">
        <div class="icon-box-circle"><i class="fas fa-gift"></i></div>
        <h3>Promotional Support</h3>
        <p>Visual aids, MR bags, product samples, and marketing materials provided free of cost.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section-padding bg-light">
  <div class="container">
    <div class="grid-2" style="align-items:center;">
      <div>
        <h2 style="margin-bottom:16px;">Start Your Pharma Business Today</h2>
        <p style="margin-bottom:20px;">Whether you are an experienced pharmaceutical distributor or starting fresh, McBrex Lifesciences provides everything you need to build a successful pharma business.</p>
        <ul style="margin-bottom:24px;padding-left:20px;list-style:disc;">
          <li style="margin-bottom:8px;">Low investment, high returns</li>
          <li style="margin-bottom:8px;">Wide product range across 6 divisions</li>
          <li style="margin-bottom:8px;">Free promotional inputs</li>
          <li style="margin-bottom:8px;">Timely delivery across India</li>
          <li>Dedicated customer support</li>
        </ul>
        <a href="/contact" class="btn btn-primary">Apply for Franchise</a>
      </div>
      <div style="background:#FFFFFF;border-radius:12px;padding:32px;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
        <h3 style="margin-bottom:20px;text-align:center;">Quick Enquiry</h3>
        <form>
          ...
          <div class="form-group">
            <select required>
              ...
              <option>Punjab</option><option>Haryana</option><option>Himachal Pradesh</option>
              <option>Uttar Pradesh</option><option>Rajasthan</option><option>Gujarat</option>
              <option>Maharashtra</option><option>Karnataka</option><option>Telangana</option>
