...
export const metadata: Metadata = {
  title: `Customer Reviews - McBrex Lifesciences`,
    ...
    <div class="header-inner">
      ...
      <nav class="header-nav">
        <a href="/" class="">Home</a>
            ...
            </div><a href="/career" class="">Career</a><a href="/customer-reviews" class="active">Customer Reviews</a><a href="/contact" class="">Contact</a>
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> Customer Reviews</div>
  </div>
</section>

<div class="page-content">
  <div class="container">
    <p class="section-subtitle">Hear what our clients and partners say about working with McBrex Lifesciences.</p>
    <div class="grid-3">
      <div class="review-card">
        <div class="review-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="review-text">"McBrex Lifesciences has been our trusted pharmaceutical partner for over 3 years. Their product quality is exceptional and delivery is always on time."</p>
        <div class="review-author">Dr. Rajesh Kumar</div>
        <div class="review-date">Pharma Distributor, Punjab</div>
      </div>
      <div class="review-card">
        <div class="review-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="review-text">"The PCD franchise support from McBrex is outstanding. Their promotional inputs and monopoly rights helped me establish a successful pharma business."</p>
        <div class="review-author">Amit Sharma</div>
        <div class="review-date">Franchise Partner, Haryana</div>
      </div>
      <div class="review-card">
        ...
        <p class="review-text">"Excellent range of cardiac care products from Cardiwin division. My patients have shown great results. Highly recommended for cardiologists."</p>
        <div class="review-author">Dr. Priya Singh</div>
        <div class="review-date">Cardiologist, Delhi</div>
      </div>
      <div class="review-card">
        <div class="review-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="review-text">"Working with McBrex has been a game changer for my business. Their ethical practices and transparent dealings make them a reliable partner."</p>
        <div class="review-author">Vikram Patel</div>
        <div class="review-date">Distributor, Gujarat</div>
      </div>
      <div class="review-card">
        <div class="review-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
        <p class="review-text">"The quality of their injectables from Criticine Care division is top-notch. We have been using their products in our hospital for 2 years without any issues."</p>
        <div class="review-author">Dr. Sneha Gupta</div>
        <div class="review-date">Hospital Administrator, UP</div>
      </div>
      <div class="review-card">
        <div class="review-stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div>
        <p class="review-text">"Their gynecology range from Gynox Remedies is comprehensive and well-formulated. My patients appreciate the quality and effectiveness."</p>
        <div class="review-author">Dr. Anjali Verma</div>
        <div class="review-date">Gynecologist, Rajasthan</div>
      </div>
    </div>
    <div style="margin-top:40px;padding:32px;background:#F5F5F5;border-radius:12px;text-align:center;">
      <h3 style="margin-bottom:12px;">Share Your Experience</h3>
      <p style="color:#666666;margin-bottom:20px;">We value your feedback. Let us know about your experience with McBrex Lifesciences.</p>
      <a href="/contact" class="btn btn-primary">Submit Your Review</a>
    </div>
  </div>
</div>
