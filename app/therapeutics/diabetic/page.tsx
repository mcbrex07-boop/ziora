...
export const metadata: Metadata = {
  title: `Diabetic - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/therapeutics">Therapeutics</a> <span>/</span> Diabetic</div>
  </div>
</section>
...
<div class="page-content">
  <div class="container">
    <div style="display:flex;align-items:center;gap:20px;margin-bottom:32px;">
      ...
      <div>
        <h2 style="margin-bottom:8px;">Diabetic</h2>
        <p style="color:#666666;">Pharmaceutical products for diabetic treatment and management.</p>
      </div>
    </div>
    <p style="margin-bottom:24px;">Our diabetic range includes high-quality formulations developed to meet the specific needs of patients. All products are manufactured in WHO-GMP certified facilities and are available for PCD Pharma Franchise distribution.</p>
    <div style="overflow-x:auto;">
      <table class="data-table">
        ...
        <tbody>
          <tr><td>Sample Diabetic Product 1</td><td>Active Molecule 500mg</td><td>Tablet</td><td>Mcbrex Lifesciences</td><td><a href="#" class="btn btn-primary" style="padding:6px 16px;font-size:12px;" data-enquiry>Enquire</a></td></tr>
          <tr><td>Sample Diabetic Product 2</td><td>Active Molecule 250mg</td><td>Capsule</td><td>Cardiwin Lifecare</td><td><a href="#" class="btn btn-primary" style="padding:6px 16px;font-size:12px;" data-enquiry>Enquire</a></td></tr>
          <tr><td>Sample Diabetic Product 3</td><td>Combination Formula</td><td>Syrup</td><td>Curicine Healthcare</td><td><a href="#" class="btn btn-primary" style="padding:6px 16px;font-size:12px;" data-enquiry>Enquire</a></td></tr>
        </tbody>
      </table>
    </div>
    <div style="margin-top:32px;padding:24px;background:#F5F5F5;border-radius:8px;text-align:center;">
      <p style="margin-bottom:16px;">Contact us for the complete diabetic product list.</p>
