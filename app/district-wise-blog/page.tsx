...
export const metadata: Metadata = {
  title: `District Wise Blog - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/blog">Blog</a> <span>/</span> District Wise Blog</div>
  </div>
</section>

<div class="page-content">
  <div class="container">
    <p class="section-subtitle">Browse pharma franchise opportunities and healthcare updates organized by district.</p>
    <div style="margin-bottom:32px;">
      <h3 style="margin-bottom:16px;color:#D92323;">Punjab</h3>
      <div class="molecule-list">
        <a href="/blog" class="molecule-item">Ludhiana</a>
        <a href="/blog" class="molecule-item">Amritsar</a>
        <a href="/blog" class="molecule-item">Jalandhar</a>
        <a href="/blog" class="molecule-item">Patiala</a>
        <a href="/blog" class="molecule-item">Bathinda</a>
        <a href="/blog" class="molecule-item">Mohali</a>
      </div>
    </div>
    <div style="margin-bottom:32px;">
      <h3 style="margin-bottom:16px;color:#D92323;">Haryana</h3>
      <div class="molecule-list">
        <a href="/blog" class="molecule-item">Ambala</a>
        <a href="/blog" class="molecule-item">Panchkula</a>
        <a href="/blog" class="molecule-item">Chandigarh</a>
        <a href="/blog" class="molecule-item">Gurgaon</a>
        <a href="/blog" class="molecule-item">Faridabad</a>
        <a href="/blog" class="molecule-item">Karnal</a>
      </div>
    </div>
    <div style="margin-bottom:32px;">
      <h3 style="margin-bottom:16px;color:#D92323;">Uttar Pradesh</h3>
      <div class="molecule-list">
        <a href="/blog" class="molecule-item">Lucknow</a>
        <a href="/blog" class="molecule-item">Kanpur</a>
        <a href="/blog" class="molecule-item">Agra</a>
        <a href="/blog" class="molecule-item">Varanasi</a>
        <a href="/blog" class="molecule-item">Meerut</a>
        <a href="/blog" class="molecule-item">Ghaziabad</a>
      </div>
    </div>
    <div style="margin-bottom:32px;">
      <h3 style="margin-bottom:16px;color:#D92323;">Rajasthan</h3>
      <div class="molecule-list">
        <a href="/blog" class="molecule-item">Jaipur</a>
        <a href="/blog" class="molecule-item">Jodhpur</a>
        <a href="/blog" class="molecule-item">Udaipur</a>
        <a href="/blog" class="molecule-item">Kota</a>
        <a href="/blog" class="molecule-item">Ajmer</a>
        <a href="/blog" class="molecule-item">Bikaner</a>
      </div>
    </div>
  </div>
</div>
