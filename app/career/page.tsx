...
export const metadata: Metadata = {
  title: `Career - McBrex Lifesciences`,
    ...
    <div class="header-inner">
      ...
      <nav class="header-nav">
        <a href="/" class="">Home</a>
            ...
            </div><a href="/career" class="active">Career</a><a href="/customer-reviews" class="">Customer Reviews</a><a href="/contact" class="">Contact</a>
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> Career</div>
  </div>
</section>

<!-- Hero -->
<section style="background:linear-gradient(135deg,#1A1A1A,#333333);padding:80px 0;text-align:center;">
  <div class="container">
    <h1 style="color:#FFFFFF;font-size:42px;margin-bottom:16px;">Join Our Team</h1>
    <p style="color:#AAAAAA;max-width:600px;margin:0 auto;">Be a part of McBrex Lifesciences and contribute to shaping the future of healthcare in India.</p>
  </div>
</section>
<div class="page-content">
  <div class="container">
    <div class="grid-2" style="align-items:center;margin-bottom:48px;">
      <div>
        <h2>Why Work at McBrex?</h2>
        <p>At McBrex Lifesciences, we believe our people are our greatest asset. We offer a dynamic work environment where innovation is encouraged and excellence is rewarded.</p>
        <ul style="padding-left:20px;list-style:disc;margin-top:16px;">
          <li style="margin-bottom:10px;">Competitive salary packages</li>
          ...
          <li style="margin-bottom:10px;">Performance-based incentives</li>
          <li>Positive work culture</li>
        </ul>
      </div>
      <div style="background:#F5F5F5;border-radius:12px;height:300px;display:flex;align-items:center;justify-content:center;">
        <i class="fas fa-users" style="font-size:80px;color:#CCCCCC;"></i>
      </div>
    </div>
    <h2 style="text-align:center;margin-bottom:32px;">Open Positions</h2>
    <div class="grid-2">
      <div class="card" style="padding:28px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
          <h3 style="margin:0;">Sales Manager</h3>
          <span style="padding:4px 12px;background:rgba(217,35,35,0.1);color:#D92323;border-radius:20px;font-size:12px;font-weight:600;">Full Time</span>
        </div>
        <p style="color:#666666;font-size:14px;margin-bottom:12px;">Looking for an experienced sales professional to lead our expansion in North India.</p>
        <div style="display:flex;gap:16px;font-size:13px;color:#999999;margin-bottom:16px;">
          <span><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i>Panchkula</span>
          <span><i class="fas fa-briefcase" style="margin-right:4px;"></i>3-5 Years</span>
        </div>
        <a href="/apply-job" class="btn btn-primary" style="padding:10px 24px;font-size:13px;">Apply Now</a>
      </div>
      <div class="card" style="padding:28px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
          <h3 style="margin:0;">Area Sales Executive</h3>
          <span style="padding:4px 12px;background:rgba(217,35,35,0.1);color:#D92323;border-radius:20px;font-size:12px;font-weight:600;">Full Time</span>
        </div>
        <p style="color:#666666;font-size:14px;margin-bottom:12px;">Field sales role for promoting our pharmaceutical products to doctors and distributors.</p>
        <div style="display:flex;gap:16px;font-size:13px;color:#999999;margin-bottom:16px;">
          <span><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i>Multiple Locations</span>
          <span><i class="fas fa-briefcase" style="margin-right:4px;"></i>1-3 Years</span>
        </div>
        <a href="/apply-job" class="btn btn-primary" style="padding:10px 24px;font-size:13px;">Apply Now</a>
      </div>
      <div class="card" style="padding:28px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
          <h3 style="margin:0;">Quality Control Analyst</h3>
          <span style="padding:4px 12px;background:rgba(217,35,35,0.1);color:#D92323;border-radius:20px;font-size:12px;font-weight:600;">Full Time</span>
        </div>
        <p style="color:#666666;font-size:14px;margin-bottom:12px;">Responsible for quality testing and documentation of incoming and outgoing products.</p>
        <div style="display:flex;gap:16px;font-size:13px;color:#999999;margin-bottom:16px;">
          <span><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i>Panchkula</span>
          <span><i class="fas fa-briefcase" style="margin-right:4px;"></i>2-4 Years</span>
        </div>
        <a href="/apply-job" class="btn btn-primary" style="padding:10px 24px;font-size:13px;">Apply Now</a>
      </div>
      <div class="card" style="padding:28px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
          <h3 style="margin:0;">Digital Marketing Executive</h3>
          <span style="padding:4px 12px;background:rgba(217,35,35,0.1);color:#D92323;border-radius:20px;font-size:12px;font-weight:600;">Full Time</span>
        </div>
        <p style="color:#666666;font-size:14px;margin-bottom:12px;">Manage digital campaigns, social media, and online presence of McBrex Lifesciences.</p>
        <div style="display:flex;gap:16px;font-size:13px;color:#999999;margin-bottom:16px;">
          <span><i class="fas fa-map-marker-alt" style="margin-right:4px;"></i>Panchkula</span>
          <span><i class="fas fa-briefcase" style="margin-right:4px;"></i>1-2 Years</span>
        </div>
        <a href="/apply-job" class="btn btn-primary" style="padding:10px 24px;font-size:13px;">Apply Now</a>
      </div>
    </div>
