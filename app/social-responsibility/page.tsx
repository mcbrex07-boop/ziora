...
export const metadata: Metadata = {
  title: `Social Responsibility - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/about">About Us</a> <span>/</span> Social Responsibility</div>
  </div>
</section>
  ...
  <div class="container">
    <div class="grid-2" style="align-items:center;margin-bottom:48px;">
      <div>
        ...
        <p>At McBrex Lifesciences, we believe that our responsibility extends beyond business. We are committed to making a positive impact on the communities we serve through various health and social initiatives.</p>
      </div>
      <div style="background:#F5F5F5;border-radius:12px;height:300px;display:flex;align-items:center;justify-content:center;">
        <i class="fas fa-hands-helping" style="font-size:80px;color:#CCCCCC;"></i>
      </div>
    </div>
    <div class="grid-2">
      <div class="card" style="padding:32px;">
        <div class="icon-box-circle" style="margin:0 0 16px 0;"><i class="fas fa-heartbeat"></i></div>
        <h3 style="margin-bottom:12px;">Community Health Initiatives</h3>
        <p style="color:#666666;">We actively participate in community health programs, providing free medical camps and health awareness sessions in underserved areas.</p>
      </div>
      <div class="card" style="padding:32px;">
        <div class="icon-box-circle" style="margin:0 0 16px 0;"><i class="fas fa-leaf"></i></div>
        <h3 style="margin-bottom:12px;">Environmental Responsibility</h3>
        <p style="color:#666666;">Our operations follow eco-friendly practices with minimal environmental impact, including sustainable packaging and waste reduction.</p>
      </div>
      <div class="card" style="padding:32px;">
        <div class="icon-box-circle" style="margin:0 0 16px 0;"><i class="fas fa-user-shield"></i></div>
        <h3 style="margin-bottom:12px;">Patient Welfare Programs</h3>
        <p style="color:#666666;">We support patient assistance programs to ensure affordable access to essential medicines for those in need.</p>
      </div>
      <div class="card" style="padding:32px;">
        <div class="icon-box-circle" style="margin:0 0 16px 0;"><i class="fas fa-balance-scale"></i></div>
        <h3 style="margin-bottom:12px;">Ethics and Compliance</h3>
        <p style="color:#666666;">We maintain the highest ethical standards in all our operations, ensuring transparency and regulatory compliance at every level.</p>
      </div>
    </div>
  </div>
</div>
