...
export const metadata: Metadata = {
  title: `State Wise Blog - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/blog">Blog</a> <span>/</span> State Wise Blog</div>
  </div>
</section>

<div class="page-content">
  <div class="container">
    <p class="section-subtitle">Explore pharma franchise opportunities and healthcare updates organized by Indian states.</p>
    <div class="grid-3">
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Punjab</h3><p style="color:#666666;font-size:14px;">Pharma franchise opportunities and healthcare updates from Punjab.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Haryana</h3><p style="color:#666666;font-size:14px;">Latest updates from Haryana including Panchkula and surrounding areas.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Himachal Pradesh</h3><p style="color:#666666;font-size:14px;">Pharma industry news and updates from Himachal Pradesh.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Uttar Pradesh</h3><p style="color:#666666;font-size:14px;">Franchise opportunities and market updates from UP.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Rajasthan</h3><p style="color:#666666;font-size:14px;">Healthcare and pharma updates from Rajasthan.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Gujarat</h3><p style="color:#666666;font-size:14px;">Pharma franchise news and updates from Gujarat.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Maharashtra</h3><p style="color:#666666;font-size:14px;">Market insights from Maharashtra including Mumbai and Pune.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Karnataka</h3><p style="color:#666666;font-size:14px;">Healthcare updates and opportunities from Karnataka.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
      <div class="card" style="padding:24px;"><h3 style="margin-bottom:12px;"><i class="fas fa-map-marker-alt" style="color:#D92323;margin-right:8px;"></i>Telangana</h3><p style="color:#666666;font-size:14px;">Pharma industry updates from Telangana and Hyderabad.</p><a href="/blog" style="color:#D92323;font-weight:600;font-size:14px;">View Posts</a></div>
    </div>
  </div>
</div>
