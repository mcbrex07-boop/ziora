...
export const metadata: Metadata = {
  title: `Apply Job - McBrex Lifesciences`,
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> <a href="/career">Career</a> <span>/</span> Apply Job</div>
  </div>
</section>
...
<div class="page-content">
  <div class="container" style="max-width:700px;">
    <div class="card" style="padding:40px;">
      ...
      <p style="text-align:center;color:#666666;margin-bottom:32px;">Fill out the form below to apply for a position at McBrex Lifesciences.</p>
      <form>
        ...
        <div class="form-group">
          ...
          <select required>
            ...
            <option>Area Sales Executive</option>
        ...
        <div class="form-group">
          ...
          <small style="color:#999999;">Accepted formats: PDF, DOC, DOCX</small>
        </div>
        <div class="form-group">
          <label>Cover Letter</label>
          <textarea placeholder="Tell us why you want to join McBrex Lifesciences"></textarea>
        </div>
