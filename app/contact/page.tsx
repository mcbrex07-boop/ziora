...
export const metadata: Metadata = {
  title: `Contact Us - McBrex Lifesciences`,
    ...
    <div class="header-inner">
      ...
      <nav class="header-nav">
        <a href="/" class="">Home</a>
            ...
            </div><a href="/career" class="">Career</a><a href="/customer-reviews" class="">Customer Reviews</a><a href="/contact" class="active">Contact</a>
...
<section class="breadcrumb-section">
  <div class="container">
    ...
    <div class="breadcrumb-nav"><a href="/">Home</a> <span>/</span> Contact</div>
  </div>
</section>
...
<div class="page-content">
  <div class="container">
    <div class="grid-2" style="gap:40px;">
      ...
      <div>
        <h2 style="margin-bottom:24px;">Contact Information</h2>
        <div class="card" style="margin-bottom:24px;">
          <div style="display:flex;gap:16px;margin-bottom:20px;">
            <div style="width:48px;height:48px;border-radius:50%;background:rgba(217,35,35,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-phone" style="color:#D92323;"></i>
            </div>
            <div>
              <h4 style="margin-bottom:4px;">Phone</h4>
              <a href="tel:+918264040991" style="color:#666666;">+91 8264040991</a>
            </div>
          </div>
          <div style="display:flex;gap:16px;margin-bottom:20px;">
            <div style="width:48px;height:48px;border-radius:50%;background:rgba(217,35,35,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-envelope" style="color:#D92323;"></i>
            </div>
            <div>
              <h4 style="margin-bottom:4px;">Email</h4>
              <a href="mailto:info@mcbrexlifesciences.com" style="color:#666666;">info@mcbrexlifesciences.com</a>
            </div>
          </div>
          <div style="display:flex;gap:16px;margin-bottom:20px;">
            <div style="width:48px;height:48px;border-radius:50%;background:rgba(217,35,35,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-map-marker-alt" style="color:#D92323;"></i>
            </div>
            <div>
              <h4 style="margin-bottom:4px;">Address</h4>
              <p style="color:#666666;font-size:14px;">351, 2nd Floor, Industrial Area, Phase-2, Panchkula-134113, Haryana, India</p>
            </div>
          </div>
          <div style="display:flex;gap:16px;">
            <div style="width:48px;height:48px;border-radius:50%;background:rgba(217,35,35,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
              <i class="fas fa-clock" style="color:#D92323;"></i>
            </div>
            <div>
              <h4 style="margin-bottom:4px;">Business Hours</h4>
              <p style="color:#666666;font-size:14px;">Monday - Saturday: 9:30 AM - 6:30 PM</p>
            </div>
          </div>
        </div>
        <div class="card" style="text-align:center;">
          <h4 style="margin-bottom:12px;">Connect on WhatsApp</h4>
          <p style="color:#666666;font-size:14px;margin-bottom:16px;">For quick responses, message us on WhatsApp.</p>
          <a href="https://wa.me/918264040991" class="btn btn-primary" style="background:#25D366;"><i class="fab fa-whatsapp" style="margin-right:8px;"></i>Chat on WhatsApp</a>
        </div>
      </div>
    </div>
    <div style="margin-top:40px;border-radius:12px;overflow:hidden;">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3431.0!2d76.8514!3d30.6942!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzDCsDQxJzM5LjEiTiA3NsKwNTEnMDUuMCJF!5e0!3m2!1sen!2sin!4v1" width="100%" height="400" style="border:0;" allowfullscreen loading="lazy"></iframe>
    </div>
  </div>
</div>
